...
<body>
    <div class="container-fluid">
        <div class="row">
            <div class="col-sm-12 bg-transparent h1 text-center">Bureau of Police Research and Development</div>
            <div class="col-sm-12 bg-transparent h1 text-center">Ministry of Home affairs</div>
            ...
            <tbody>
                ...
                <td class="col-sm-9 h3 bg-primary g-gradient">Work Allocation</td>
            </tbody>
            <tbody>
                <tr scope="row">5</tr>
...
<body>
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-sm-2 h2  bg-info bg-gradient"><a href="/static/contactus.html">Contact Us</a></div>
            <img src="./img/police3.jpg"   style="height:500px;"  alt="police">
            <h2 class="text-center bg-success">Evolution of BPRD</h2>
